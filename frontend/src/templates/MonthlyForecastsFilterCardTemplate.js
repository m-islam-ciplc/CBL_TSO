 ...
 *   - formFields[1]: Territory (select, conditional, flex: auto) - optional
 *   - formFields[2]: Dealer (select)
 *   - formFields[3]: Search (input with prefix)
 ...
 * @returns {JSX.Element} Monthly Forecasts Filter card JSX
 */
export const MonthlyForecastsFilterCardTemplate = ({
  title = 'Filter Orders',
  formFields = [],
  buttons = [],
