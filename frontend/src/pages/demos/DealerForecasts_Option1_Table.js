...
// Demo data - simulating API response
...
function DealerForecasts_Option1_Table() {
        ...
        <Row justify="space-between" align="middle">
          <Col>
            <Title level={3} style={{ margin: 0, fontSize: '20px' }}>
              <BarChartOutlined /> Dealer Forecasts - Option 1: Table View
            </Title>
            <Text type="secondary" style={{ display: 'block', marginTop: '8px' }}>
              Expandable table showing dealer forecasts with product details
            </Text>
          </Col>
        </Row>
      </Card>
...
export default DealerForecasts_Option1_Table;
