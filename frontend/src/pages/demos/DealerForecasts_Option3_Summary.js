...
function DealerForecasts_Option3_Summary() {
        ...
        <Row justify="space-between" align="middle">
          <Col>
            <Title level={3} style={{ margin: 0, fontSize: '20px' }}>
              <BarChartOutlined /> Dealer Forecasts - Option 3: Summary View
            </Title>
            <Text type="secondary" style={{ display: 'block', marginTop: '8px' }}>
              Tabbed view with summary by dealer, product, and territory
            </Text>
          </Col>
        </Row>
      </Card>
...
export default DealerForecasts_Option3_Summary;
